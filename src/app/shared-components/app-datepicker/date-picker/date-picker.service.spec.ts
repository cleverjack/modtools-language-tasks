...
describe('Service: DatePicker', () => {
  ...
  it('should check getConfig method for dates format', inject([DatePickerService],
    (service: DatePickerService) => {
      ...
      expect((config1.min as Moment).isSame(moment('2016-10-25', 'YYYY-MM-DD'), 'day')).toBe(true);
      expect((config1.max as Moment).isSame(moment('2017-10-25', 'YYYY-MM-DD'), 'day')).toBe(true);
      ...
      expect((config2.min as Moment).isSame(moment('2016-10-25', 'YYYY-MM-DD'), 'day')).toBe(true);
      expect((config2.max as Moment).isSame(moment('2017-10-25', 'YYYY-MM-DD'), 'day')).toBe(true);
